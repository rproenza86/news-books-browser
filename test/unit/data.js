export const book_items = [
    {
        ...
        volumeInfo: {
            ...
            publishedDate: "2008",
            description:
                "Presents a history of the Internet company, discussing the lives of its founders, its development of a superior seach engine, and the innovative way it has used ads, mapping, geographical imagery, and digital books to achieve its success.",
            averageRating: 4.5,
            ratingsCount: 5,
            imageLinks: {
                thumbnail:
                    "http://books.google.com/books/content?id=UVz06fnwJvUC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"
            },
            language: "en",
            previewLink:
                "http://books.google.com/books?id=UVz06fnwJvUC&pg=PA57&dq=google&hl=&as_ebook=1&cd=1&source=gbs_api",
            infoLink:
                "https://play.google.com/store/books/details?id=UVz06fnwJvUC&source=gbs_api",
            canonicalVolumeLink:
                "https://market.android.com/details?id=book-UVz06fnwJvUC"
        },
        accessInfo: {
            country: "US",
            viewability: "PARTIAL",
    ...
    },
    {
        id: "MjJVLcjl86cC",
        volumeInfo: {
            title: "Using Google AdWords and AdSense, Enhanced Edition",
            ...
            imageLinks: {
                thumbnail:
                    "http://books.google.com/books/content?id=MjJVLcjl86cC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"
            },
            language: "en",
            previewLink:
                "http://books.google.com/books?id=MjJVLcjl86cC&pg=SA19-PA3&dq=google&hl=&as_ebook=1&cd=2&source=gbs_api",
            infoLink:
                "https://play.google.com/store/books/details?id=MjJVLcjl86cC&source=gbs_api",
            canonicalVolumeLink:
                "https://market.android.com/details?id=book-MjJVLcjl86cC"
        },
        accessInfo: {
            country: "US",
            viewability: "PARTIAL",
